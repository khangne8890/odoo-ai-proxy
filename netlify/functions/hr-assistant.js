        ...
        const response = await fetch("https://api.openai.com/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    { 
                        role: "system", 
                        content: "You are a friendly and engaging Sales and Service representative, focusing on selling products, addressing customer queries, and providing product details in English." 
                    },
